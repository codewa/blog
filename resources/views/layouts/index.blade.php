...
<title>小海 - 小海博客</title>
@show
<meta name="keywords" content="小海,小海博客,Laravel,PHP,PHP框架,教程,资源,学习,笔记" />
<meta name="description" content="小海博客致力于提供优质学习资源,分享个人笔记.">
            ...
            <div class="row margin-b-50">
                <div class="col-sm-6 sm-margin-b-30">
                    <div class="footer-address">
                        ...
                        <p class="footer-address-text">如果你有什么疑问或者交流，下面联系方式可以找到小海~.~</p>
                        <p class="footer-address-text">QQ:610271</p>
                        <a class="footer-address-link" href="mailto:610271@qq.com">610271@qq.com</a>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="footer-testimonials">
                        ...
                        <span class="footer-testimonials-author">&#8212; xiaohai</span>
                    </div>
                </div>
            </div>

            <ul class="list-inline footer-copyright">
                <li class="footer-copyright-item">Copyright &#169; 2016 xiaohai. All Rights Reserved.</li>
            </ul>
        </div>
    </footer>
</div>
